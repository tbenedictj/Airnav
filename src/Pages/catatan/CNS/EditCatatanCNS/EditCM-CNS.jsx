...
const EditCMCNS = () => {
    ...
    useEffect(() => {
        // Fetch the document data for editing
        const fetchData = async () => {
            try {
                ...
                if (docSnap.exists()) {
                    setFormData({
                        ...docSnap.data(),
                        bukti: null // Do not overwrite 'bukti' with Firestore data, handle it separately
                    });
                    setImagePreview(docSnap.data().buktiUrl);
                    setSignatureData(docSnap.data().signatureUrl);
                } else {
            ...
            <div className="bg-white rounded-lg shadow p-6 sm:p-8">
                ...
                <div className="bg-gray-100 p-3 shadow rounded-lg mb-6">
                    <nav className="text-gray-600">
                        ...
                        <Link to="/cm-cns" className="text-blue-500">List Catatan Mingguan CNS</Link>
                        <span className="mx-2">/</span>
