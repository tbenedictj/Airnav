...
const LKSupSinglePDF = () => {
  ...
  useEffect(() => {
    ...
    const handlePrintPDF = () => {
        ...
        pdf.setFontSize(14);
        const title = "LAPORAN KERUSAKAN - SUPPORT";
    ...
    return (
        <div className="container-fluid flex-col sticky h-screen mt-14 mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="bg-gray-100 p-3 shadow rounded-lg mb-6">
                <nav className="text-gray-600">
                  ...
                  <Link to="/lk-sup" className="text-blue-500"> Data Laporan Kerusakan Support</Link>
                  <span className="mx-2">/</span>
        ...
        <div className="p-8">
          <div className="bg-white shadow-md rounded p-6 max-w-2xl mx-auto">
            <h2 className="text-xl font-semibold text-center mb-4">Laporan Kerusakan Support</h2>
