...
const EditCHSup = () => {
    ...
    const { id } = useParams(); // Getting the document ID from the URL params
            ...
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    setFormData({
                        ...
                        bukti: null // Do not preload file here
                    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/ch-sup'); // Redirect to the list page
        } catch (error) {
    ...
    return (
        <div className="container-fluid flex-col sticky max-w-4xl w-screen sticky h-screen mt-14 mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="bg-white rounded-lg shadow p-6 sm:p-8">
                <h1 className="text-2xl font-bold mb-4 text-center sm:text-left">Edit Catatan Harian</h1>
                ...
                <form onSubmit={handleSubmit} className="shadow space-y-6">
                    <div className="shadow space-y-4">
                        ...
                        {/* Signature Component */}
                        <div className="mb-4">
                            <Tandatangan onSignatureChange={handleSignatureChange} signatureUrl={signatureData} />
                        </div>
                    </div>
