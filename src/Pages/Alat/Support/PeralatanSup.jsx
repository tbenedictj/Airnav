          ...
          <table className="min-w-full border border-gray-300">
            <thead>
              <tr className="text-black border-b border-gray-300 bg-gray-100">
                {['namaAlat', 'kategoriAlat', 'SNOutdoor', 'SNIndoor', 'Tahun'].map(field => (
                  <th key={field} className="border-gray-300 border-r px-4 py-2 text-left text-sm sm:text-base">
                    <button onClick={() => handleSort(field)} className="bg-transparent text-black ml-2 hover:text-gray-700">
