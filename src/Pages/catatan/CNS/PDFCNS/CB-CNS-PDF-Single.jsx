...
const CBCnsSinglePDF = () => {
  ...
  const handlePrintPDF = () => {
    ...
    pdf.setFontSize(14);
    const title = "CATATAN PEMELIHARAAN BULANAN - CNS";
  ...
  return (
    <div className="container-fluid flex-col sticky h-screen mt-14 mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <h1 className="text-2xl font-bold mb-4 text-center sm:text-left">PDF Catatan Bulanan</h1>
    
        <div className="bg-gray-100 p-3 shadow rounded-lg mb-6">
            <nav className="text-gray-600">
              <span className="mx-2">/</span>
              <Link to="/cb-cns" className="text-blue-500"> Data Pemeliharaan Bulanan CNS</Link>
              <span className="mx-2">/</span>
              <span>Detail Catatan Bulanan</span>
            </nav>
        </div>

    <div className="p-8">
      <div className="bg-white shadow-md rounded p-6 max-w-2xl mx-auto">
        <h2 className="text-xl font-semibold text-center mb-4">Catatan Bulanan CNS</h2>
