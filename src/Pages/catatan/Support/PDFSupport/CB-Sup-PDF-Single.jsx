...
const CBSupSinglePDF = () => {
  ...
  const handlePrintPDF = () => {
    ...
    pdf.setFontSize(14);
    const title = "CATATAN PEMELIHARAAN BULANAN - SUPPORT";
  ...
  return (
    ...
    <div className="p-8">
      <div className="bg-white shadow-md rounded p-6 max-w-2xl mx-auto">
        <h2 className="text-xl font-semibold text-center mb-4">Catatan Bulanan Support</h2>
